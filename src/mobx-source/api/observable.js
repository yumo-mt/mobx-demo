...
export function getEnhancerFromAnnotation(annotation) {
    var _a, _b;
    return !annotation ? deepEnhancer : (_b = (_a = annotation.options_) === null || _a === void 0 ? void 0 : _a.enhancer) !== null && _b !== void 0 ? _b : deepEnhancer;
}
/**
...
const observableFactories = {
    ...
    object(props, decorators, options) {
        return extendObservable(globalState.useProxies === false || (options === null || options === void 0 ? void 0 : options.proxy) === false
